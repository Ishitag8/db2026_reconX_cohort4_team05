...
public class GlobalExceptionHandler {
    ...
    private static final String BASE = "https://reconx.dbtraining.com/errors/";

    @ExceptionHandler(TradeNotFoundException.class)
    public ProblemDetail notFound(TradeNotFoundException ex) {
        ProblemDetail pd = ProblemDetail.forStatusAndDetail(HttpStatus.NOT_FOUND, ex.getMessage());
        pd.setType(URI.create(BASE + "trade-not-found"));
    ...
    public ProblemDetail duplicate(DuplicateTradeRefException ex) {
        ...
        pd.setType(URI.create(BASE + "duplicate-trade-ref"));
    ...
    public ProblemDetail invalid(InvalidTradeException ex) {
        ...
        pd.setType(URI.create(BASE + "invalid-trade"));
    ...
    public ProblemDetail mismatch(ReconciliationMismatchException ex) {
        ...
        pd.setType(URI.create(BASE + "reconciliation-mismatch"));
