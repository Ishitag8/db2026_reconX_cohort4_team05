...
/**
 * ============================================================================
 * TICKET-ADV050 — Trade JPA entity
 * (with @ManyToOne, @CreatedDate, @LastModifiedDate)
 * TICKET-ADV052 — Hibernate Envers @Audited (auto rev table — see Day 4 guide)
 * TICKET-ADV067 — Soft delete via @SQLRestriction (filters deleted rows on
 * SELECT)
 *
...
public class Trade {
    ...
    public void setTradeRef(String v) {
        this.tradeRef = v;
    }
    ...
    public void setCounterparty(Counterparty v) {
        this.counterparty = v;
    }
    ...
    public void setTradeDate(LocalDate v) {
        this.tradeDate = v;
    }

    public void setStatus(TradeStatus v) {
        this.status = v;
    }
}
