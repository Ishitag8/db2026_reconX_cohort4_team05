...
class TradeControllerWebMvcTest {
    ...
    void testCreateTrade_authenticated_returns201() throws Exception {
        ...
        Trade fakeSavedTrade = mock(Trade.class);
        when(fakeSavedTrade.getId()).thenReturn(42L);
        ...
        when(tradeService.create(any(TradeRequest.class), any(String.class))).thenReturn(fakeSavedTrade);
        when(tradeMapper.toResponse(any(Trade.class))).thenReturn(fakeResponse);
