...
class TradeLifecycleIT {
    ...
    // Use Apache HttpClient-backed RestTemplate so PATCH is supported reliably
    RestTemplate http = new RestTemplate(new org.springframework.http.client.HttpComponentsClientHttpRequestFactory());
